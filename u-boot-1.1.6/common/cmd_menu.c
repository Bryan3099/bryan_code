...
void menu_shell(void)
{
    ...
    while (1)
    {
        ...
        switch (c)
        {
			case 'n':
			{
                strcpy(cmd_buf, "tftp 30000000 u-boot.bin; nand erase bootloader; nand write 0x30000000 0 40000)");
                run_command(cmd_buf, 0);
                break;
			}
  /*          case 'o':
  ...
  */          
            case 'k':
            {
                strcpy(cmd_buf, "tftp 30000000 uImage; nand erase kernel; nand write.jffs2 0x30000000 kernel $(filesize)");
                run_command(cmd_buf, 0);
                break;
            }
            ...
            case 'j':
            {
                strcpy(cmd_buf, "tftp 30000000 jz2440.jffs2; nand erase root; nand write.jffs2 0x30000000 root $(filesize)");
                run_command(cmd_buf, 0);
                break;
            }
#if 0
            ...
            case 'y':
            {
                strcpy(cmd_buf, "tftp 30000000 jz2440.yaffs; nand erase root; nand write.yaffs 0x30000000 root $(filesize)");
                run_command(cmd_buf, 0);
                break;
            }
/*
